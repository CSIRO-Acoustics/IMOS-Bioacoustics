...
% to Echoview.
    ...
    uicontrol(main_panel, ...
        ...
        'Visible',      'off', ... %%% Haris 08 July 2019 - it is now mandatory and user will be asked anyway while creating EV files.
        'Units',        'normalized', ...
        'Position',     [bpos base bwidth hght ]);
...
% HAC file and final cleaned Echoview variable.
    ...
    uicontrol(main_panel, ...
        ...
        'TooltipString', 'Export .ev files to HAC format and re-import', ...
        'Tag',          'export_import_HAC', ...
        'String',       'Export to HAC and re-import (do if *.raw, ECS, gps, roll, and pitch files are modified in the EV file)', ...
        'Value',        settings.export_import_HAC, ...
        'FontWeight',   'bold', ...
        'Visible',      vis_EF, ...
        'Units',        'normalized', ...
...
%         'Position',     [0.6 base 0.1 hght ]);
    ...
    uicontrol(main_panel, ...
        'Style',        'checkbox', ...
        'TooltipString', [ 'Exported motion correction factor - ' ...
                            settings.export_motion_correction_factor_variable_name ], ...
        'Tag',          'export_motion_correction_factor', ...
        'String',       'Motion correction factor', ...
        'Value',        settings.export_motion_correction_factor, ...
        'Visible',      vis_EF, ...
        'Units',        'normalized', ...
        'Position',     [0.45 base 0.1 hght ]);
...
% % % % %             60 ^ (3 - get(get_control(parent, 'time offset units'), 'Value'));
        ...
        setting.max_depth = ...
            str2double(get(get_control(parent, 'max depth'), 'String'));
        if isnan(setting.max_depth)
            warndlg('Can''t understand max depth value, must be a valid number');
            error('Can''t understand max depth value, must be a valid number');
        end
