% GET_ALL_CSL  
%
%     *** Deprecated - now use get_all_csl3  instead ***
%
%         Get CSIRO-standard-level hydro & CTD data
%     
% INPUT:  
...
dpth = path_pc_or_nix('eez_data/boa_duplicates/');
...
fnm = path_pc_or_nix('eez_data/hydro/niwa_csl');
load(fnm);
...
fnm = path_pc_or_nix('eez_data/hydro/french_csl');
load(fnm);
...
if scr==0
   pth = path_pc_or_nix('eez_data/wod01csl/');
else
   pth = path_pc_or_nix('eez_data/wod01csl3/');
   pth2 = path_pc_or_nix('eez_data/wod01csl/');
end
